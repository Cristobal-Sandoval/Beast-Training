...
export default function useAdminState() {
  ...
  return {
    ...
    handleSavePlan: plans.handleSavePlan, handleDeletePlan: plans.handleDeletePlan, handleEditPlanClick: plans.handleEditPlanClick, handleAddPlanClick: plans.handleAddPlanClick, handleTogglePopular: plans.handleTogglePopular, handleToggleVisible: plans.handleToggleVisible, handleDeleteProgress: alumnos.handleDeleteProgress,

...
// Custom Mock Client for local demonstration (Offline mode)
class MockSupabase {
  constructor() {
    this.auth = {
      listeners: new Set(),
      ...
      async signInWithPassword({ email, password }) {
        ...
        // Save initial user profile in list if not exists
  ...
  from(table) {
    ...
    const query = {
      ...
      // Implement thenable interface so we can await it
          ...
          if (table === 'profiles') {
            ...
            if (profiles.length === 0) {
              profiles = [
                {
                  id: 'admin-uuid-123',
                  email: 'admin@beasttraining.cl',
                  full_name: 'Admin Beast',
                  role: 'admin',
                  status: 'active',
                  workout_plan: 'Rutina del Admin.'
                },
                {
                  id: 'user-uuid-456',
                  email: 'user@beasttraining.cl',
            ...
            if (this._queryType === 'update') {
              // Update profile matching eqField
              if (this._eqField === 'id') {
              ...
              if (this._eqField === 'id') {
                ...
                data = profiles; // Return all profiles for admin view
              }
              ...
              posts = [
                {
                  ...
                  content: `La fuerza es la base de todas las cualidades físicas...`,
                ...
                },
                {
                  ...
                  content: `Entrenar intensamente es solo una parte de la ecuación...`,
            ...
            if (announcements.length === 0) {
              announcements = [
                {
                  id: 'a1',
                  title: '¡Atención: Feriado 16 de Julio!',
                  content: 'Estimada comunidad, les informamos que el gimnasio permanecerá cerrado el próximo jueves 16 de Julio por feriado nacional. Retomamos actividades el viernes 17 en horario normal. ¡Sigan entrenando duro!',
                  priority: 'normal',
                  created_at: '2026-07-01T12:00:00Z'
                },
                {
                  id: 'a2',
                  title: '⚠️ Mantenimiento de la Zona de Fuerza',
                  content: 'Hoy a las 14:00 hrs se realizará la mantención trimestral de las poleas y jaulas en la sala de musculación. Se mantendrá habilitada la zona de peso libre. Disculpen las molestias, es para mantener sus entrenamientos seguros.',
                  priority: 'priority',
...
export const supabase = isPlaceholderMode ? new MockSupabase() : realSupabase;
